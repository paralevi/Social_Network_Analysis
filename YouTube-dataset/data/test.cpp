...
int main() {
	//test();
	ifstream file1("1-edges.csv");
	int total_cnt=getFileLine(file1);
	...
	file1.seekg(ios::beg);
	SaltonCosine(file1, train_cnt, test_cnt);
	CommonNeighbor(file1,train_cnt,test_cnt);
	return 0;
}
